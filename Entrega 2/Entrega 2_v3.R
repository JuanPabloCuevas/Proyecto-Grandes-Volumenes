...
# Etapa 4: Modelo logístico con Ridge
# Etapa 5: Modelo árbol de clasificación
# Etapa 6: Random Forest
# Etapa 7: Gradient Boosting (GBM)
# Etapa 8: XGBoost
# Etapa 9: Comparación de todos los modelos
# ============================================================================
...
# ============================================================================
# ETAPA 5: MODELO DE ÁRBOL DE CLASIFICACIÓN (RPART)
# ============================================================================
...
# ============================================================================
# ETAPA 6: RANDOM FOREST (RANGER - Optimizado para datos grandes)
# ============================================================================
...
cat("\n\n=== ETAPA 9: COMPARACIÓN DE MODELOS ===")
